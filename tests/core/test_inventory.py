...
class Test(object):
    ...
    def test_hosts(self):
        ...
        assert h1["var3"] == "3"
        assert h1["var4"] == "ALL"
        assert list(h1.keys()) == ['name', 'groups', 'var1', 'var2', 'var3', 'var4']
        assert list(h1.values()) == ['host1', ['g1', 'g2'], '1', '2', '3', 'ALL']
        assert list(h1.items()) == [('name', 'host1'), ('groups', ['g1', 'g2']),
        ...
        assert h2["var3"] == "3"
        assert h2["var4"] == "ALL"
        assert list(h2.keys()) == ['name', 'groups', 'var1', 'var2', 'var3', 'var4']
        assert list(h2.values()) == ['host2', ['g2', 'g1'], 'a', 'b', '3', 'ALL']
        assert list(h2.items()) == [('name', 'host2'), ('groups', ['g2', 'g1']), ('var1', 'a'),
        ...
        assert h3["var3"] == "q"
        assert h3["var4"] == "Z"
        assert list(h3.keys()) == ['name', 'groups', 'var3', 'var1', 'var2', 'var4']
        assert list(h3.values()) == ['host3', ['g4', 'g3'], 'q', 'a', 'b', 'Z']
        assert list(h3.items()) == [('name', 'host3'), ('groups', ['g4', 'g3']), ('var3', 'q'),
        ...
        assert h4["var3"] == "q"
        assert h4["var4"] == "Z"
        assert list(h4.keys()) == ['name', 'groups', 'var1', 'var4', 'var3', 'var2']
        assert list(h4.values()) == ['host4', ['g3', 'g4'], 'A', 'Z', 'q', 'b']
        assert list(h4.items()) == [('name', 'host4'), ('groups', ['g3', 'g4']), ('var1', 'A'),

...
html_theme_options = {
    ...
    # an arbitrary url.
    'navbar_links': [
        ("Github", "https://github.com/napalm-automation/brigade", True),
    ],
...
latex_documents = [
    (master_doc, 'brigade.tex', 'brigade Documentation',
     'David Barroso', 'manual'),
]
...
man_pages = [
    (master_doc, 'brigade', 'brigade Documentation',
     [author], 1)
]

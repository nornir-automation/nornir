...
def get_flat_models_from_field(
    field: ModelField, known_models: Set[Type["BaseModel"]]
) -> Set[Type["BaseModel"]]:
    """
...
def multivalue_literal_field_for_schema(
...
def get_annotation_from_field_info(
    ...
    def go(type_: Any) -> Type[Any]:
        if (
            ...
            or lenient_issubclass(type_, ConstrainedList)
        ):
            return type_
        ...
        if isinstance(type_, type):
            if issubclass(type_, str) and not issubclass(
